...
class TodoEntry extends DataClass implements Insertable<TodoEntry> {
  ...
  TodoEntry({required this.id, required this.title, required this.description});
  ...
  TodoEntry copyWith({String? id, String? title, String? description}) =>
      TodoEntry(
        id: id ?? this.id,
